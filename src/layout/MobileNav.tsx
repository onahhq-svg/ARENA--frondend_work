...
// Bottom bar — lightning goes to Live
...
// Drawer — matches desktop sidebar exactly
const menuItems = [
  { icon: Home, label: 'Home', href: '/' },
      ...
      <AnimatePresence>
        {menuOpen && (
          <>
            ...
            >
              {/* Profile header — click to open Profile */}
                ...
                {menuItems.map(item => {
                  ...
                  return (
                    <a
                      ...
                      className={cn(
                        "flex items-center gap-4 px-5 py-3 transition-all relative",
              ...
              <div className="px-5 py-4 border-t border-white/5 flex gap-3">
                <button
                  onClick={() => { window.location.href = '/wallet'; setMenuOpen(false); }}
