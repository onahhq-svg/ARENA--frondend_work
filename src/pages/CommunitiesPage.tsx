...
const communities = [
  { id: '1', name: 'Premier League Fans',  members: '124K', category: 'Football',    privacy: 'public',  emoji: '⚽' },
  { id: '2', name: 'NBA Talk',             members: '98K',  category: 'Basketball',  privacy: 'public',  emoji: '🏀' },
  { id: '3', name: 'Champions League',     members: '210K', category: 'Football',    privacy: 'public',  emoji: '🏆' },
  { id: '4', name: 'Fantasy Football HQ',  members: '55K',  category: 'Fantasy',     privacy: 'private', emoji: '🎯' },
  { id: '5', name: 'Tennis World',         members: '34K',  category: 'Tennis',      privacy: 'public',  emoji: '🎾' },
  { id: '6', name: 'Prediction Masters',   members: '18K',  category: 'Predictions', privacy: 'private', emoji: '🔮' },
];
      ...
      <div className="divide-y divide-white/5">
        <AnimatePresence>
          {displayed.map((community, i) => (
            <motion.div key={community.id}
              ...
              <button onClick={e => toggleJoin(e, community.id)}
        ...
        {displayed.length === 0 && (
          <div className="py-16 text-center px-6">
            ...
            <p className="text-sm text-[#71767b] mt-1">Join a community to see it here</p>
          </div>
        )}
      </div>
    </div>
